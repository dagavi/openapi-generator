...
public class DagaviFastAPIServerCodegen extends AbstractPythonCodegen {
    ...
    final Logger LOGGER = LoggerFactory.getLogger(DagaviFastAPIServerCodegen.class);

    protected String sourceFolder;

    private static final String SERVER_PORT = "serverPort";
    private static final String NAME = "dagavi-fastapi";
    ...
    public DagaviFastAPIServerCodegen() {
        super();
